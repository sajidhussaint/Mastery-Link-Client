...
const Contact = () => {
  ...
  const onSubmit = (data) => {
    emailjs
      .send("service_g5gd8ws", "template_rb0xrsi", data, {
        publicKey: "t-yO8AReem65_yL_5",
      })
      .then(
        () => {
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z"
          ...
          >
            ...
            <div className="flex justify-between w-full px-3">
              <button
                className="shadow bg-primary hover:bg-green-900 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded"
                type="submit"
              >
                Send Message
              </button>
