            ...
            <div className="w-full md:w-9/12 mx-2 h-64">
              ...
              <div className="bg-gray-50 p-6 shadow-xl rounded-md  animate-fade-down ">
                ...
                <button
                  ...
                  className="bg-gray-100 block w-full text-blue-800 text-sm font-semibold rounded-lg hover:bg-gray-200 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs p-3 my-4 shadow border"
                >
                  Edit
                </button>
              </div>
