...
import { instructorLogin } from "../../api/authenticationApi";
...
const InstructorLoginForm = () => {
  ...
  const submitData = async (data) => {
    setErr("");
    try {
      dispatch(instructorActions.setEmail(data.email));
  ...
  return (
    <form action="" onSubmit={handleSubmit(submitData)}>
      ...
      {err && (
        <div className="animate-fade bg-red-200 px-6 py-2  my-4 rounded-md text-lg flex items-center mx-auto max-w-lg">
          <svg
            viewBox="0 0 24 24"
